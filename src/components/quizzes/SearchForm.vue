<template>
  <div
    class="fixed left-0 top-0 z-50 h-screen w-full bg-white p-6 lg:relative lg:h-max lg:w-max lg:p-0"
  >
    <form class="mx-auto flex h-11 w-80 justify-between rounded-[0.625rem] border bg-gray-50 pl-4">
      <search-form-group />
